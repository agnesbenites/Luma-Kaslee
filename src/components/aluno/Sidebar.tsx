...
import { Sparkles, Home, BookOpen, User, LogOut, CalendarDays } from "lucide-react";

const nav = [
  { href: "/dashboard/aluno", label: "Início", icon: Home },
  { href: "/dashboard/aluno/sessoes", label: "Minhas Sessões", icon: BookOpen },
  { href: "/dashboard/aluno/calendario", label: "Calendário", icon: CalendarDays },
  { href: "/dashboard/aluno/perfil", label: "Meu Perfil", icon: User },
];

export default function SidebarAluno({ user }: { user: { name?: string | null } }) {
